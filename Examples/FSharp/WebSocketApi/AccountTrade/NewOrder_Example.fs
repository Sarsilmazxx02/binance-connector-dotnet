...
let main argv =
    ...
    websocket.AccountTrade.NewOrderAsync("BNBUSDT", Models.Side.BUY, Models.OrderType.LIMIT, Models.TimeInForce.GTC, price = 300, quantity = 1, cancellationToken = CancellationToken.None) |> Async.AwaitTask |> Async.RunSynchronously
