...
let main argv =
    ...
    websocket.AccountTrade.CancelAndReplaceOrderAsync("BNBUSDT", Side.SELL, OrderType.LIMIT, "STOP_ON_FAILURE", cancelOrderId = 12, timeInForce = TimeInForce.GTC, quantity = 10.1m, price = 295.92m) |> Async.AwaitTask |> Async.RunSynchronously
