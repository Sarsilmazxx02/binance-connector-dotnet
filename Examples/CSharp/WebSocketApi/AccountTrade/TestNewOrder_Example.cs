namespace Binance.Spot.WebSocketApiExamples
{
    ...
    public class TestNewOrder_Example
    {
        public static async Task Main(string[] args)
        {
            ...
            await websocket.AccountTrade.TestNewOrderAsync(symbol: "BNBUSDT", side: Models.Side.BUY, type: Models.OrderType.LIMIT, timeInForce: Models.TimeInForce.GTC, price: 300, quantity: 1, cancellationToken: CancellationToken.None);
